    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-primary">
                ...
                <p class="card-category">Tambahkan solusi baru untuk kerusakan HVAS</p>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('langkah_perbaikan') is-invalid @enderror" id="langkah_perbaikan" name="langkah_perbaikan" rows="6" required>{{ old('langkah_perbaikan') }}</textarea>
